...
const HeroBanner = ({movie, onBack, onNext}) => {
  ...
  return (
    <div className=" w-full flex flex-col justify-center">
        ...
        <div 
        style={{backgroundImage: `linear-gradient(to bottom, rgba(0, 0, 0, 0.9), rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.98) 90%), url(${imgPath + movie.backdrop_path})`,}} 
        className={`w-full h-screen  bg-center bg-cover bg-no-repeat rounded`}></div>
